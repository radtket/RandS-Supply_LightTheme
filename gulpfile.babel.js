...
gulp.task('copy', () => {
	...
	// Fonts
	// gulp.src(['node_modules/bootstrap-sass/assets/fonts/bootstrap/*']).pipe(gulp.dest('dist/assets/fonts'));
});
...
gulp.task('initialBuild', callback =>
	runSequence('clean', 'copy', ['images', 'styles', 'js-dep', 'js'], 'html', callback)
);
