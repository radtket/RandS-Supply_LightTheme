...
mapboxgl.accessToken =
	"pk.eyJ1IjoicmFkdGtldCIsImEiOiJjamVoYTBrdnEwaXhqMzNvZzEyZ215MG04In0.D98pv5P9HqrB16SbdjKNRA";
...
function createPopUp(currentFeature) {
	...
	const popup = new mapboxgl.Popup({
		...
		<ul>
			<li>${currentFeature.properties.address}. <br>${
